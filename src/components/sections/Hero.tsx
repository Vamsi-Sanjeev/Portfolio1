    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-12 leading-relaxed max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="mt-16 flex flex-wrap justify-center items-center gap-3 animate-fade-in" style={{ animationDelay: '0.6s' }}>
            {['Java', 'AIML', 'UI/UX', 'Full Stack', 'Cloud'].map((tech, index) => (
              <span
                key={index}
                className="px-4 py-2 rounded-full bg-white/5 text-sm backdrop-blur-sm hover:bg-white/10 transition-all duration-300 border border-white/10 hover:border-purple-500/30 hover:scale-105"
